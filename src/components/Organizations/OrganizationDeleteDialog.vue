...
<template>
    <Dialog header="Confirmation" :style="{ width: '350px' }" :modal="true" :visible="props.show"
        ...
        <template #footer>
            <Button label="No" icon="pi pi-times" class="p-button-text p-button-success" autofocus @click="closeDialog" />
            <Button label="Yes" icon="pi pi-check" class="p-button-text p-button-danger" @click="submitDialog" />
        </template>
    </Dialog>
</template>
