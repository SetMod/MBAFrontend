...
<template>
    <div class="p-card m-auto my-5 w-30rem">
        ...
        <div class="p-card-body  text-left">
            ...
            <div class="field flex flex-column">
                ...
                <InputNumber id="name" v-model.number="v$.analyzeSupport.$model" required="true" autofocus
                    :class="v$.analyzeSupport.$invalid ? 'p-invalid' : ''" :min="0.1" :max="1" :step="0.1" />
            ...
            <div class="field flex flex-column">
                ...
                <InputNumber id="name" v-model.number="v$.analyzeLift.$model" required="true" autofocus
                    :class="v$.analyzeLift.$invalid ? 'p-invalid' : ''" :min="0.1" :max="1" :step="0.1" />
            ...
            <div class="field flex flex-column">
                ...
                <InputNumber id="name" v-model.number="v$.analyzeConfidence.$model" required="true" autofocus
                    :class="v$.analyzeConfidence.$invalid ? 'p-invalid' : ''" :min="0.1" :max="1" :step="0.1" />
            ...
            <div class="field flex justify-content-around">
                <Button label="Analyze" :disabled="!selectedFile || !selectedReport"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const rules = {
            ...
            analyzeSupport: { required, decimal, between: between(0.1, 1) },
            analyzeLift: { required, decimal, between: between(0.1, 1) },
            analyzeConfidence: { required, decimal, between: between(0.1, 1) },
