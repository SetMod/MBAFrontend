...
<template>
    <Dialog v-model:visible="showEditConfirmDialog" header="Confirmation" :style="{ width: '350px' }" :modal="true">
        ...
        <template #footer>
            <Button label="Cancel" icon="pi pi-check" severity="warning" autofocus @click="closeConfirmDialog" />
            <Button label="Confirm" icon="pi pi-times" severity="success" @click="submitEdit" />
        </template>
    </Dialog>
    ...
    <div class="p-card p-4 mx-3 w-29rem">
        ...
        <div class="p-card-footer">
            ...
            <div v-else class="flex justify-content-around align-items-center">
                ...
                <Button label="Update" severity="warning" :disabled="userEditValidate.$invalid"
